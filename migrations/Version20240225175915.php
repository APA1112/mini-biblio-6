 ...
 */
final class Version20240225175915 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE libro ADD socio_id INT NOT NULL, ADD isbn VARCHAR(255) NOT NULL, ADD precio_compra INT DEFAULT NULL');
